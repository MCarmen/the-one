...
//	}
	...
	@Override
	/**
	 * If no metrics/directives from other nodes are received during the 
	 * control cycle the congestionState should not be updated.
	 *  
	...
	protected boolean shouldUpdateCongestionState(boolean sync) {
		return (this.receivedCtrlMsgInDirectiveCycle);
	}

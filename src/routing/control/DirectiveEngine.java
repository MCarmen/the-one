...
public abstract class DirectiveEngine {
	 ...
	 * directive cycle. False otherwise. This flag should be reset each directive cycle.
	 */
	 ...
	 */
	public abstract void addMetric(MetricMessage metric); 
	 ...
	 * If the condition {@link #shouldUpdateCongestionState()} is not satisfied,  
	 * the generated directive has the same properties as the last generated one. 
	 *  
	 ...
	 * @return In case the generator decides not to create a new directive 
	 * the message is not fulfilled and the method returns null, otherwise, 
	 * the message is fulfilled with the directive fields and the method returns 
	 * the detailed information about the data usedto generate the directive.
	 * This method needs to be overriden by the subclasses.
	 */
	public DirectiveDetails generateDirective(ControlMessage message, boolean sync) {
		...
		if (this.shouldUpdateCongestionState(sync)) {
	...
	/**
	 * Method that resets all the settings after a directive has been generated. 
	 */
	protected abstract void resetDirectiveCycleSettings();
	
	/**
	 * Method that checks if the congestionState should be updated. This 
	 * method is a support method used by {@link #generateDirective(ControlMessage, boolean)}
	 *  
	 * @param sync Flag indicating whether the message is created synchronously
	 * through a generator or asynchronously (without generator) 
	 * @return <code>true</code> if the congestionState should be updated 
	 * <code>false</code> otherwise.
	 */
	protected abstract boolean shouldUpdateCongestionState(boolean sync);

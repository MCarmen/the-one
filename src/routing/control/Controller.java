...
public class Controller {
	...
	/** time -setting id ({@value}) in the control name space */
	...
	public Controller(SprayAndWaitControlRouter router) {
		...
		this.time = (s.contains(TIME_S)) ? s.getCsvDoubles(TIME_S, 2) : null;	
	}
	...
	/**
	 * Method called each time a new direcive has to be generated through the 
	 * {@link SprayAndWaitControlRouter#createNewDirectiveMessage} method or 
	 * by the event generated by the eventGenerator when it 
	 ...
	 * No directive is generated before or after the generation time specified
	 * by the {@link #time} setting.   
	...
	public boolean isWarmup() {
		return this.time[0] > SimClock.getTime();
	}

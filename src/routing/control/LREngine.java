...
public class LREngine extends DirectiveEngine {
	 ...
	 * {@link #congestionPrediction}. This method also sets the properties 
	 * {@link #slope} and {@link #coeficientOfDetermination} of the Linear regression.
	 * 
	...
	private void calculateCongestionPredictionAt(double time) {	
		...
		if(this.lrCongestionInputs.size() > 1) {
			...
			congestionPrediction = congestionReadingsArr[0];
		}
